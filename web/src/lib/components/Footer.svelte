  ...
  <div class="container mx-auto px-6">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
      <div class="col-span-1 md:col-span-2">
        <div class="flex items-center gap-2 text-white font-bold text-2xl mb-6">
          <BrandMark size="sm" />
          {site.brand}
        </div>

        <p class="text-zinc-400 max-w-sm mb-8">{site.tagline}</p>
      ...
      <div>
        ...
        <ul class="space-y-4 text-zinc-400">
          <li>
            <a
              href="/#features"
              class="hover:text-emerald-400 transition-colors">Features</a
            >
          </li>
          <li>
            <a href="/#macros" class="hover:text-emerald-400 transition-colors"
              >Macros</a
            >
          </li>
          <li>
      ...
      <div>
        ...
        <ul class="space-y-4 text-zinc-400">
          ...
          <li>
            <a href="/license" class="hover:text-emerald-400 transition-colors"
              >License</a
            >
          </li>
        </ul>
    ...
    <div
      class="border-t border-zinc-900 pt-8 flex flex-col md:flex-row justify-between items-center gap-4"
    >
      <p class="text-zinc-500 text-sm">
        © 2026 Sidecar. All rights reserved. {site.legalDisclaimer}
      </p>
