...
const FIXTURE_URL_PATH = '/tests/harness/fixture.html';
const WXT_SCRIPT_PATH = path.join(
  __dirname,
  '../../../wxt/.output/chrome/content-scripts/chatgpt-dock.js',
);
const WXT_CSS_PATH = path.join(
  __dirname,
  '../../../wxt/.output/chrome/content-scripts/chatgpt-dock.css',
);
...
test.describe('WXT Parity Harness (fixture)', () => {
  ...
  test.describe('Conversation View', () => {
    test.beforeEach(async ({ page }) => {
      ...
      await page.goto(FIXTURE_URL_PATH);
