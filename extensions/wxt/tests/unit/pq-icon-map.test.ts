...
import iconMap from '../../public/vendor/game-icons.net/ffffff/pq-icon-map-v2.json';
import schema from '../../public/vendor/game-icons.net/ffffff/pq-icon-map.schema.json';
